...
function Dashboard(){
	...
	const {isLoading: isLoadingTransports, count: transportsCount} = useTransports();
	const {isLoading: isLoadingWarehouses, count: warehousesCount} = useWarehouses();
				...
				<div className="row">
					...
					<div className="col-lg-8">
						<div className="row">
							...
							<InfoCard href="/transports"  icon={<Truck />} iconStyle={{color: "#4154f1", background: "#dce0ff"}}  title="Transports" value={transportsCount}>
								<span className="text-success small pt-1 fw-bold">8</span> <span>delivering</span>
							</InfoCard>
							<InfoCard href="/warehouses"  icon={<Building />} iconStyle={{color: "#9cf141", background: "#dce0ff"}}  title="Warehouses" value={warehousesCount} />							<InfoCard href="/employees"  icon={<FilePersonFill />} iconStyle={{color: "#2eca6a", background: "#d5ffde"}} title="Employees" value={123} />
						</div>
					</div>
